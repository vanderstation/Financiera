        ...
        <ul class="nav">
            <li class="nav-profile">
                <a href="javascript:;" data-toggle="nav-profile">
                    ...
                    <div class="image">
                        <img src="<?php echo SERVERURL; ?>assets/user/user-2.jpg" alt="" />
                    </div>
                    <div class="info">
        ...
        <ul class="nav">
            ...
            <li>
                <a href="bootstrap_4.html">
                    <div class="icon-img">
                        <img src="<?php echo SERVERURL; ?>assets/logo/logo-bs4.png" alt="" />
                    </div>
            ...
            <li class="has-sub">
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="<?php echo SERVERURL; ?>ajax/">AJAX</a></li>
                    <li><a href="<?php echo SERVERURL; ?>angularjs/">ANGULAR JS</a></li>
                    <li><a href="<?php echo SERVERURL; ?>angularjs8/">ANGULAR JS 8 <i class="fa fa-paper-plane text-theme"></i></a></li>
                    <li><a href="<?php echo SERVERURL; ?>laravel/">LARAVEL <i class="fa fa-paper-plane text-theme"></i></a></li>
                    <li><a href="<?php echo SERVERURL; ?>vuejs/">VUE JS <i class="fa fa-paper-plane text-theme"></i></a></li>
                    <li><a href="<?php echo SERVERURL; ?>reactjs/">REACT JS <i class="fa fa-paper-plane text-theme"></i></a></li>
                    <li><a href="<?php echo SERVERURL; ?>material/">MATERIAL DESIGN</a></li>
                    <li><a href="<?php echo SERVERURL; ?>apple/">APPLE DESIGN</a></li>
                    <li><a href="<?php echo SERVERURL; ?>transparent/">TRANSPARENT DESIGN <i class="fa fa-paper-plane text-theme"></i></a></li>
                    <li><a href="<?php echo SERVERURL; ?>facebook/">FACEBOOK DESIGN <i class="fa fa-paper-plane text-theme"></i></a></li>
                </ul>
            </li>
            <li class="has-sub">
                <a href="javascript:;">
